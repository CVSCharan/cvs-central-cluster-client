              ...
              <section className="rounded-xl border bg-card/30 backdrop-blur-sm p-6 sm:p-8 shadow-sm">
                ...
                <div className="space-y-4 text-sm sm:text-base">
                  <p>
                    ...
                    to us when you register on the website, express an interest
                    in obtaining information about us or our products and
                    services, when you participate in activities on the website,
                  ...
                  <ul className="list-disc pl-5 space-y-2">
                    <li>
                      Name and contact data (such as your email address, phone
                      number, and address)
                    </li>
                    <li>
                    ...
                    <li>
                      Payment data (such as your credit card number and billing
                      address)
                    </li>
                    <li>
              ...
              <section className="rounded-xl border bg-card/30 backdrop-blur-sm p-6 sm:p-8 shadow-sm">
                ...
                <div className="space-y-4 text-sm sm:text-base">
                  ...
                  <ul className="list-disc pl-5 space-y-2">
                    ...
                    <li>
                      To request feedback and to improve our website and
                      services
                    </li>
