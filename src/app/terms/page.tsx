              ...
              <section className="rounded-xl border bg-card/30 backdrop-blur-sm p-6 sm:p-8 shadow-sm">
                ...
                <div className="space-y-4 text-sm sm:text-base">
                  <p>
                    ...
                    and graphics on the Site and the trademarks, service marks,
                    and logos contained therein are owned or controlled by us or
              ...
              <section className="rounded-xl border bg-card/30 backdrop-blur-sm p-6 sm:p-8 shadow-sm">
                ...
                <div className="space-y-4 text-sm sm:text-base">
                  ...
                  <p>
                    ...
                    content is accurate, not in violation of any rights, and not
              ...
              <section className="rounded-xl border bg-card/30 backdrop-blur-sm p-6 sm:p-8 shadow-sm">
                ...
                <div className="space-y-4 text-sm sm:text-base">
                  ...
                  <p>
                    ...
                    OR COMPLETENESS OF THE SITE'S CONTENT OR THE CONTENT OF ANY
